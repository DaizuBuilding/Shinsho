...
function setAnnouncementScript() {
    ...
    let announceScript = [...(terminalDigitBack ? ['./announcement/00100.wav', './announcement/00201.wav', `./announcement/lines/Shinto_${aLineName}.wav`, `./announcement/${aLineDestination}.wav`] : []), './announcement/00600.wav', `'./announcement/stations/${stationIndex}.wav'`, `'./announcement/stations/${stationIndex}.wav'`, './announcement/00701.wav'];
